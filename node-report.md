...
Generated on: 2026-09-26 18:09:41
...
| nuaa | 南京航空航天大学 (NUAA) | 教育网 (CERNET) | LibreSpeed | ❌ FAIL | ✅ PASS | ✅ PASS | ✅ PASS (8/8) | ICMP: Check-Host result polling timeout |
...
| iqiyi | 爱奇艺 (iQIYI) | 爱奇艺 (iQIYI) | SingleFile | ✅ PASS (3/3 nodes OK) | ✅ PASS | ✅ PASS | ✅ PASS (8/8) | All tests passed |
| xiaohongshu | 小红书 (RED) | 腾讯云 (Tencent Cloud CDN) | SingleFile | ✅ PASS (3/3 nodes OK) | ✅ PASS | ❌ FAIL | ❌ FAIL (3/8) | HTTP: HTTP request failed; Multi: Multi-thread test failed: only 3/8 threads succeeded |
| migu | 咪咕快游 (MIGU Quick Game) | 中国移动云 (China Mobile Cloud) | SingleFile | ✅ PASS (2/3 nodes OK) | ✅ PASS | ✅ PASS | ✅ PASS (8/8) | All tests passed |
