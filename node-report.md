...
Generated on: 2026-09-19 18:09:18
...
| nuaa | 南京航空航天大学 (NUAA) | 教育网 (CERNET) | LibreSpeed | ❌ FAIL | ✅ PASS | ✅ PASS | ✅ PASS (7/8) | ICMP: Check-Host result polling timeout |
| xcc | 四川西昌学院 (XCC) | 教育网 (CERNET) | LibreSpeed | ❌ FAIL | ✅ PASS | ✅ PASS | ✅ PASS (7/8) | ICMP: Check-Host result polling timeout |
| baiduyun | 百度云盘 (Baidu Netdisk) | 百度云 (Baidu Cloud) | SingleFile | ❌ FAIL | ✅ PASS | ✅ PASS | ✅ PASS (8/8) | ICMP: Check-Host result polling timeout |
| bilibili | 哔哩哔哩 (Bilibili) | 阿里云 (Alibaba Cloud) | SingleFile | ❌ FAIL | ✅ PASS | ✅ PASS | ✅ PASS (8/8) | ICMP: Check-Host result polling timeout |
| arknights | 明日方舟 (Arknights) | 阿里云OSS (Alibaba Cloud OSS) | SingleFile | ❌ FAIL | ✅ PASS | ✅ PASS | ✅ PASS (8/8) | ICMP: Check-Host result polling timeout |
| sina | 新浪主站 (Sina) | 新浪混合云 (Sina CDN) | SingleFile | ✅ PASS (1/3 nodes OK) | ✅ PASS | ✅ PASS | ✅ PASS (8/8) | All tests passed |
| wangyi | 网易主站 (Netease) | 网易混合云 (Netease CDN) | SingleFile | ❌ FAIL | ✅ PASS | ✅ PASS | ✅ PASS (8/8) | ICMP: Check-Host API HTTP 429 |
| danzai | 蛋仔派对 (DanZai) | 阿里云 (Alibaba Cloud) | SingleFile | ✅ PASS (3/3 nodes OK) | ✅ PASS | ✅ PASS | ✅ PASS (8/8) | All tests passed |
| yuanshen | 原神官网 (Genshin Impact) | 阿里云 (Alibaba Cloud) | SingleFile | ❌ TIMEOUT | ❌ TIMEOUT | ❌ TIMEOUT | ❌ TIMEOUT | Node test timeout after 60s |
| yuanshen | 原神官网 (Genshin Impact) | 阿里云 (Alibaba Cloud) | SingleFile | ✅ PASS (2/3 nodes OK) | ❌ FAIL | ❌ FAIL | ✅ PASS (8/8) | TCP: Port 443 connection timeout (3s); HTTP: HTTP request failed |
| xqtd | 星穹铁道官网 (Star Rail) | 阿里云 (Alibaba Cloud) | SingleFile | ❌ FAIL | ✅ PASS | ✅ PASS | ✅ PASS (8/8) | ICMP: Check-Host result polling timeout |
...
| pdd | 拼多多 (Pinduoduo) | 网宿 (ChinaNetCenter) | SingleFile | ✅ PASS (2/3 nodes OK) | ✅ PASS | ✅ PASS | ✅ PASS (8/8) | All tests passed |
